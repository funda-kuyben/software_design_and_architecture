public class TestEagerInitialization {
    ...
    public static void main(String[] args) {
        ...
        SingletonExampleEagerInitialization singletonExampleEagerInitialization1 = SingletonExampleEagerInitialization
                .getInstance();
        SingletonExampleEagerInitialization singletonExampleEagerInitialization2 = SingletonExampleEagerInitialization
                .getInstance();
